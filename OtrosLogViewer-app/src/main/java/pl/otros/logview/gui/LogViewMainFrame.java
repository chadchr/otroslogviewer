    ...
    final DelayedSwingInvoke delayedSearchResultUpdate = new DelayedSwingInvoke() {
      ...
      protected void performActionHook() {
        ...
        try {
          ...
          LogViewPanelI lvp = otrosApplication.getSelectedLogViewPanel();
          if (lvp != null) {
              OtrosJTextWithRulerScrollPane<JTextPane> logDetailWithRulerScrollPane = lvp.getLogDetailWithRulerScrollPane();
